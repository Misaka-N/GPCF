...
def get_pretrain_args():
    ...
    # Datasets
    parser.add_argument("--dataset", type=str, nargs='+', default=['Amazon_Photo','Amazon_Computer'],
    ...
    parser.add_argument("--output_dim", type=int, default=256, help="output dimension(also dimension of projector and answering fuction)")
    parser.add_argument("--path", type=str, default="pretrained_gnn/Amazon0.pth", help="model saving path")

    # Pretrain Process
    parser.add_argument("--neighbor_num", type=int, default=50, help="neighbor node num for neighbor sampler")
...
def get_downstream_args():
    ...
    parser.add_argument("--hidden_dim", type=int, default=256, help="hidden dimension")
    parser.add_argument("--output_dim", type=int, default=256, help="output dimension(also dimension of projector and answering fuction)")
    parser.add_argument("--batch_size", type=int, default=400, help="batch size for nodes")

    # Prompt
    parser.add_argument("--prompt_num", type=int, default=2, help="prompt num for each component")
